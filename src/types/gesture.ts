 ...
 * ジェスチャーの種類
 */
export type GestureType = 'None' | 'Victory' | 'Closed_Fist' | 'Open_Palm' | 'Pointing_Up' | 'Thumb_Up' | 'Thumb_Down' | 'ILoveYou';
 ...
 * ジェスチャーイベントの種類
 */
export type GestureEventType = 'gesture_change' | 'victory_detected' | 'v_close_action';
