...
export class GestureTracker {
   ...
   * トラッキング開始
   */
  async start(videoElement: HTMLVideoElement, callbacks: GestureTrackerCallbacks = {}): Promise<void> {
   ...
   * ジェスチャーの変化を処理
   */
  private handleGestureChange(handedness: Handedness, newGesture: GestureType, previousGesture: GestureType): void {
    console.log(`[GestureTracker] Gesture changed (${handedness}): ${previousGesture} -> ${newGesture}`);
