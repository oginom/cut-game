...
export class ScoreDisplay {
  ...
  public showScoreAnimation(
    ...
    // アニメーション終了後に要素を削除
    setTimeout(() => {
      if (this.animationContainer && animElement.parentNode === this.animationContainer) {
   ...
   */
  public dispose(): void {
    if (this.container && this.scoreElement && this.scoreElement.parentElement) {
