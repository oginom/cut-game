...
- [ ] TimerConfigとTimerCallbacks型が定義されている
- [ ] GameTimerが実装され、30秒のカウントダウンが動作する
- [ ] TimerDisplayが実装され、画面右上にタイマーが表示される
- [ ] 残り10秒以下で表示が赤色になる
- [ ] 残り5秒以下で点滅する
- [ ] 30秒経過時に自動的にゲームが終了する
- [ ] リザルト画面にスコアが正しく表示される
- [ ] ESCキーによる強制終了も引き続き動作する
...
- [ ] SpawnConfigとDifficultyConfig型が定義されている
- [ ] SpawnManagerが実装され、定期的に宝物が出現する
- [ ] 時間経過と共に出現間隔が短くなる
- [ ] 時間経過と共に移動速度が上がる
- [ ] 左右からランダムに出現する
- [ ] 宝物の種類がランダムに選ばれる
...
- [ ] gameConfig.tsにすべてのパラメータがまとまっている
- [ ] 当たり判定が適切に動作する
- [ ] ロープの物理挙動が自然
- [ ] 移動速度が適切
- [ ] 出現間隔が適切
